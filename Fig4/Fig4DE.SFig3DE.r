...
HCGratio_mean <- cbind(apply(HCGratio_1C2C_para,2,mean),apply(HCGratio_2C4C_para,2,mean),apply(HCGratio_4C8C_para,2,mean))
MCGratio_mean <- cbind(apply(MCGratio_1C2C_para,2,mean),apply(MCGratio_2C4C_para,2,mean),apply(MCGratio_4C8C_para,2,mean))
LCGratio_mean <- cbind(apply(LCGratio_1C2C_para,2,mean),apply(LCGratio_2C4C_para,2,mean),apply(LCGratio_4C8C_para,2,mean))
plot(1,type="n",xaxt="n",bty="o",xlab="",ylab="Parameter value",ylim=c(0,1),xlim=c(1,3));box(lwd=2)
points(HCGratio_mean[1,],type="b",col=cccol[1],pch=19,lty=1,lwd=2)
points(HCGratio_mean[2,],type="b",col=cccol[2],pch=19,lty=1,lwd=2)
points(HCGratio_mean[3,],type="b",col=cccol[3],pch=19,lty=1,lwd=2)
points(MCGratio_mean[1,],type="b",col=cccol[1],pch=15,lty=2,lwd=2)
points(MCGratio_mean[2,],type="b",col=cccol[2],pch=15,lty=2,lwd=2)
points(MCGratio_mean[3,],type="b",col=cccol[3],pch=15,lty=2,lwd=2)
points(LCGratio_mean[1,],type="b",col=cccol[1],pch=17,lty=3,lwd=2)
points(LCGratio_mean[2,],type="b",col=cccol[2],pch=17,lty=3,lwd=2)
points(LCGratio_mean[3,],type="b",col=cccol[3],pch=17,lty=3,lwd=2)
# legend("topleft",c("u","d","p"),col=cccol,pch=19,lwd=2,bty="n")
# legend("topright",c("High CpG ratio","Moderate CpG ratio","Low CpG ratio"),col=cccol[1],lty=seq(3),pch=c(19,15,17),lwd=2,bty="n")
dev.off()

pdf("SFig3DE.ConditionalParameters.ATAC_K4.pdf",width=5,height=5)
par(mar=c(8,6,4,4))
...
plot(1,type="n",xaxt="n",bty="o",xlab="",ylab="Parameter value",ylim=c(0,1),xlim=c(1,3));box(lwd=2)
points(HATACratio_mean[1,],type="b",col=cccol[1],pch=19,lty=1,lwd=2)
points(HATACratio_mean[2,],type="b",col=cccol[2],pch=19,lty=1,lwd=2)
points(HATACratio_mean[3,],type="b",col=cccol[3],pch=19,lty=1,lwd=2)
points(MATACratio_mean[1,],type="b",col=cccol[1],pch=15,lty=2,lwd=2)
points(MATACratio_mean[2,],type="b",col=cccol[2],pch=15,lty=2,lwd=2)
points(MATACratio_mean[3,],type="b",col=cccol[3],pch=15,lty=2,lwd=2)
points(LATACratio_mean[1,],type="b",col=cccol[1],pch=17,lty=3,lwd=2)
points(LATACratio_mean[2,],type="b",col=cccol[2],pch=17,lty=3,lwd=2)
points(LATACratio_mean[3,],type="b",col=cccol[3],pch=17,lty=3,lwd=2)
# legend("topleft",c("u","d","p"),col=cccol,pch=19,lwd=2,bty="n")
# legend("topright",c("High chromatin accessibility","Moderate chromatin accessibility","Low chromatin accessibility"),col=cccol[1],lty=seq(3),pch=c(19,15,17),lwd=2,bty="n")
...
plot(1,type="n",xaxt="n",bty="o",xlab="",ylab="Parameter value",ylim=c(0,1),xlim=c(1,3));box(lwd=2)
points(HK4_mean[1,],type="b",col=cccol[1],pch=19,lty=1,lwd=2)
points(HK4_mean[2,],type="b",col=cccol[2],pch=19,lty=1,lwd=2)
points(HK4_mean[3,],type="b",col=cccol[3],pch=19,lty=1,lwd=2)
points(MK4_mean[1,],type="b",col=cccol[1],pch=15,lty=2,lwd=2)
points(MK4_mean[2,],type="b",col=cccol[2],pch=15,lty=2,lwd=2)
points(MK4_mean[3,],type="b",col=cccol[3],pch=15,lty=2,lwd=2)
points(LK4_mean[1,],type="b",col=cccol[1],pch=17,lty=3,lwd=2)
points(LK4_mean[2,],type="b",col=cccol[2],pch=17,lty=3,lwd=2)
points(LK4_mean[3,],type="b",col=cccol[3],pch=17,lty=3,lwd=2)
# legend("topleft",c("u","d","p"),col=cccol,pch=19,lwd=2,bty="n")
# legend("topright",c("High H3K4me3 signal","Moderate H3K4me3 signal","Low H3K4me3 signal"),col=cccol[1],lty=seq(3),pch=c(19,15,17),lwd=2,bty="n")
dev.off()
